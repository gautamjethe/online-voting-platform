...
if($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "Select * from generalscretarycandidates where username='$username'";
    ...
    if($num == 0) {
        if(($password == $cpassword) && $exists==false) {
            ...
            $sql = "INSERT INTO `generalscretarycandidates` ( `username`, 
...
<div class="container my-4 ">
    ...
    <form action="" method="post">
        ...
        <div class="form-group"> 
            ...
            <input type="text" class="form-control" id="email" pattern=".+@nhitm\.ac\.in" size="30" required
